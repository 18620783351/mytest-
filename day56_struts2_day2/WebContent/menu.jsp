									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center border=0>
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/abc/addCustomerUI.action"  target=main>－ 新增客户</A>
													</TD>
												</TR>
												<TR> 
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/abc/findAllCustomer.action" target=main>－ 客户列表</A>
													</TD>
												</TR>
											</TBODY>
										</TABLE>
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/abc/addLinkManUI.action" target=main>－ 新增联系人</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/abc/findAllLinkMan.action" target=main>－联系人列表</A>
													</TD>
												</TR>
